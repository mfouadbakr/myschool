...
<?php 
  ...
  <?php
  $_SESSION['school'] = School::createSchoolObj($_GET['id']);
  ?>
  ...
  <div class="row profile">
        ...
        <a href="#btn-levels" class="btn btn-sm btn-color-2">Apply now</a>
				</div>
				<!-- END SIDEBAR BUTTONS -->
      ...
      <div class="profile-usermenu bg-white pb-2 mb-3">
		...
		<div class="col-md-9">
          ...
          <!--Tab - Levels-->
          <div>
            <h3 class="border-bottom border-dark" id="btn-levels">School Levels</h3>
            <select id="filterProgramUser" class="form-control form-control-sm mb-3">
              <option value="">--Choose Program--</option>
              <?php $_SESSION['school']->printProgFilter(); ?>
            </select>
            
            <!--Levels-->
            <div id="levelsResult"></div>
          </div>
            </div>
		</div>
  </div>
